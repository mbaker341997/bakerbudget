      ...
      {budgetState.loading ? (
        ...
        budgetState.budget && (
          <Container>
            <Row>
              <Col>
                <h1>{budgetState.budget.title}</h1>
              </Col>
              <Col>
            ...
            <Row>
              <Container>
                ...
                <ul>
                  <li>
                    Total Income:{" "}
                    {CURRENCY_FORMATTER.format(budgetState.budget.incomeTotal)}
                  </li>
                  <li>
                    Total Expenses:{" "}
                    {CURRENCY_FORMATTER.format(budgetState.budget.expenseTotal)}
                  </li>
                  <li>
                    Total Savings:{" "}
                    {CURRENCY_FORMATTER.format(
                      budgetState.budget.incomeTotal -
                        budgetState.budget.expenseTotal
                    )}{" "}
                    vs target of{" "}
                    {CURRENCY_FORMATTER.format(
                      budgetState.budget.incomeTarget -
                        budgetState.budget.expenseTarget
                    )}{" "}
                  </li>
                </ul>
              </Container>
